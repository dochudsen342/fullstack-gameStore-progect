...
import {
    getLoginStoreIsLoading,
    getLoginStoreLoginFnc,
} from '../../model/selectors/loginStoreSelectors'
            ...
            <div className={cl['register-card']}>
                ...
                <form onSubmit={handleSubmit(onLoginSubmit)} className={cl['register-form']}>
                    ...
                    <FormInput
                        ...
                        type='password'
                    />
                    <Button className={cl['submit-button']}>Войти</Button>
                </form>
                <div className={cl['login-link']}>
                    <AppLink className={cl.registerLink} href='/register'>
