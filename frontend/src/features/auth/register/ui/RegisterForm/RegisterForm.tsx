...
import {
    getFormFieldsServerErrors,
    getRegisterFnc,
    getRegisterIsLoading,
    getValidateNickname,
} from '../../model/selectors/getRegiterSelectors'
            ...
            <div className={cl['register-card']}>
                ...
                <form onSubmit={handleSubmit(onRegisterSubmit)} className={cl['register-form']}>
                    <FormInput
                        ...
                        ErrorText={errorMessage.nicknameError}
                        id='nickname'
                        htmlFor='nickname'
                    ...
                    <FormInput
                        ...
                        ErrorText={errors.email?.message || errorMessage.emailError}
                        id='email'
                        htmlFor='email'
                    ...
                    <FormInput
                        ...
                        type='password'
                    />
                    <Button className={cl['submit-button']}>Зарегистрироваться</Button>
                </form>

                <div className={cl['login-link']}>
                    <AppLink className={cl.registerLink} href='/login'>
