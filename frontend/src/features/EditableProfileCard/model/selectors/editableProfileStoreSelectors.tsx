...
export const getProfileIsEdit = (state: EditableProfileStore) => state.isEdit
...
export const getProfileCloseNotification = (state: EditableProfileStore) => state.closeNotification
