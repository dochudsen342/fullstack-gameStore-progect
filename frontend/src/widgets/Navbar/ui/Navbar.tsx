...
import { getUserAuthData, getUserLogout, useUserStore } from '@/src/entities/User'
    ...
    return (
        <header className={styles.header}>
            ...
            <div className={styles.searchSection}>
                <Input type='text' className={styles.searchInput} placeholder='Найти товар' />
            </div>
